...
The only passing spec on this branch will be the [auth0 spec](cypress/tests/e2e-auth-providers/auth0.spec.ts); all others will fail. Please note that your test user will need to authorize your Auth0 app before the tests will pass.
...
The **only passing spec on this branch** will be the [okta spec](cypress/tests/e2e-auth-providers/okta.spec.ts); all others will fail.
...
The **only passing spec on this branch** will be the [cognito spec](cypress/tests/e2e-auth-providers/cognito.spec.ts); all others will fail.
...
The **only passing spec** when run with `yarn dev:google` will be the [google spec](cypress/tests/e2e-auth-providers/google.spec.ts); all others will fail.
